export const filterData = [
    ...
    {
        items: [
            { name: 'Apartments', value: '4' },
            { name: 'Townhouses', value: '16' },
            { name: 'Villas', value: '3' },
            { name: 'Penthouses', value: '18' },
            { name: 'Hotel Apartments', value: '21' },
            { name: 'Villa Compounds', value: '19' },
            { name: 'Residential Plots', value: '14' },
            { name: 'Residential Floors', value: '12' },
            { name: 'Residential Buildings', value: '17' },
        ],
